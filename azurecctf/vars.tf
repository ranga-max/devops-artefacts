...
##Enable Module Switches

variable "enable_rbac_module" {
  description = "Flag to disable or diable a module"
  type = bool
  default = true
}
...
variable "enable_pl_module" {
  description = "Flag to disable or diable a module"
  type = bool
  default = true
}

variable "enable_sa_module" {
  description = "Flag to disable or diable a module"
  type = bool
  default = true
}

variable "enable_cccluster_module" {
  description = "Flag to disable or diable a module"
  type = bool
  default = true
}
